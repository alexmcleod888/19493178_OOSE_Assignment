...
/*Author: Alex McLeod
 *Purpose: Subclass of FacebookMessenger that takes the occurrences of each keyword during the current
...
public class FacebookMessengerSub extends FacebookMessenger
{
	...
	public FacebookMessengerSub()
	{
		super();
	}
	
	//purpose: hook method used by FacebookMessenger's template class StubKeywordTest to add the occurrences of each keyword during the current
